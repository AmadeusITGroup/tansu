...
> 
> Use [StoreOptions.equal](./tansu.storeoptions.equal.md) instead
> 
...
[StoreOptions.equal](./tansu.storeoptions.equal.md) takes precedence over notEqual if both are defined.
